...
boss_win_sfx = r'assets\sfx\music\boss_win.mp3'
...
"""DIFFICULTY_STAGES = [
    # Stage 1
    {"spawn_interval": 100,"enemy_speed": 1.5, "enemies_to_clear": 3},
    # Stage 2
...
if DEBUGGING:
    ...
    DIFFICULTY_STAGES = [
        ...
        # Stage 2
        {"spawn_interval": 100,"enemy_speed": 2.5, "enemies_to_clear": 4},
        # Stage 3   
        {"spawn_interval": 100,"enemy_speed": 2.5, "enemies_to_clear": 5},
        # Stage 4
        {"spawn_interval": 100,"enemy_speed": 2.5, "enemies_to_clear": 5},
        # Stage 5
        {"spawn_interval": 100, "enemy_speed": 3, "enemies_to_clear": 6},
        # Stage 6
        {"spawn_interval": 100, "enemy_speed": 3, "enemies_to_clear": 6},
        # Stage 7
